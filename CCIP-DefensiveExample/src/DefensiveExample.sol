...
// Erros Customizados. Eles são usados para fornecer uma mensagem de erro mais descritiva e barata.
...
/**
 * DISCLAIMER
 * Esse é um contrato exemplo e usa valores fixos para facilitar o entendimento.
 * O código desse contrato não foi auditado.
 * Não use esse código em ambiente de produção.
*/

/// @title - Um contrato simples para transferir e receber tokens e dados cross-chain
/// @dev - Esse exemplo mostra como recuperar tokens caso a transação reverta
contract DefensiveExample is CCIPReceiver, OwnerIsCreator {
    //////////////////////////////////////////////////////////////////////////////////
    /////////////////////////////// TYPES DECLARATIONS ///////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////
    ...
    // Exemplo de erros. Você pode ter inúmeros tipos.
    enum ErrorCode {
        RESOLVED, //RESOLVED fica primeiro, pois é ele que queremos como padrão.
        FAILED //Se algo ocorrer errado atualizaremos para FAILED
        // Poderiamos ter muitos outros aqui...
    }

    // Exemplo de Estrutura para organizar o ID transação e o código de Erro
    struct FailedMessage {
        bytes32 messageId;
        ErrorCode errorCode; //Note que adicionamos o ENUM declarado acima como parte da estrutura.
    }
    event MessageSent(
    ...
    // Armazena a mensagem que falhou e o seu estado.
    EnumerableMap.Bytes32ToUintMap internal s_failedMessages;
    // Essa variável é usada para simular um erro seguido de revert na função processMessage.
    ...
    // Mapping para armazenar as blockchains que podem receber mensagens desse contrato.
    mapping(uint64 => bool) public allowlistedDestinationChains;
    // Mapping para armazenar as blockchains que podem enviar mensagens para esse contrato.
    mapping(uint64 => bool) public allowlistedSourceChains;
    // Mapping para armazenar os endereços que podem enviar mensagem para esse contrato.
    mapping(address => bool) public allowlistedSenders;
    // Mapping para armazenar o conteúdo da mensagem que falhou.
